...
WebUI.selectOptionByValue(findTestObject('02_MOBILE/0203_Product/020301_PDP/Page_/ddMobPilihKurirPDP'), GlobalVariable.Value25, 
    GlobalVariable.isTrue)

WebUI.verifyOptionSelectedByValue(findTestObject('02_MOBILE/0203_Product/020301_PDP/Page_/ddMobPilihKurirPDP'), GlobalVariable.Value25, 
    GlobalVariable.isTrue, 0)

WebUI.selectOptionByValue(findTestObject('02_MOBILE/0203_Product/020301_PDP/Page_/ddMobPilihLayananKurirPDP'), GlobalVariable.Value10, 
    GlobalVariable.isTrue)

WebUI.verifyOptionSelectedByValue(findTestObject('02_MOBILE/0203_Product/020301_PDP/Page_/ddMobPilihLayananKurirPDP'), GlobalVariable.Value10, 
    GlobalVariable.isTrue, 0)
