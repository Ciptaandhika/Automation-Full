...
WebUI.sendKeys(findTestObject('02_MOBILE/0203_Product/020301_PDP/textBoxJumlah'), Keys.chord(Keys.DELETE))

WebUI.delay(3)

WebUI.setText(findTestObject('02_MOBILE/0203_Product/020301_PDP/textBoxJumlah'), '1')
