...
if(WebUI.verifyElementPresent(findTestObject('02_MOBILE/0204_Trade/020402_OrderConfirm/lblAlertCoupon'), 60)){
	
	println('Kupon tidak dapat digunakan')
}else {

println('Kupon dapat digunakan')
}
