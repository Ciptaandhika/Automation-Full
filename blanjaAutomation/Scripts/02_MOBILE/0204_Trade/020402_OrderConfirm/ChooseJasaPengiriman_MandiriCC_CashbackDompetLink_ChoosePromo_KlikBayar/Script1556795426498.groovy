...
not_run: WebUI.scrollToElement(findTestObject('02_MOBILE/0204_Trade/020403_MethodPayment/Page_Checkout - BLANJA.com  blanja/h3Cashback'), 
    0)

WebUI.delay(3)

WebUI.click(findTestObject('02_MOBILE/0204_Trade/020403_MethodPayment/CashbackSlider'))
...
WebUI.click(findTestObject('02_MOBILE/0204_Trade/020402_OrderConfirm/btnKartuKreditMandiri'))

WebUI.delay(3)

WebUI.verifyElementPresent(findTestObject('02_MOBILE/0204_Trade/020403_MethodPayment/Bank Mandiri/selectPromoMandiriCC'), 
    0)
