...
WebUI.selectOptionByLabel(findTestObject('02_MOBILE/0204_Trade/020402_OrderConfirm/ddBankPromotionBNI'), 'LimitedBankPromotion', 
    false)
...
if(WebUI.verifyElementPresent(findTestObject('02_MOBILE/0204_Trade/020402_OrderConfirm/lblAlertBankPromotion'), 0)){
	
	println('Promo Telah digunakan')
}else {
		println('Promo Belum digunakan')
	}
