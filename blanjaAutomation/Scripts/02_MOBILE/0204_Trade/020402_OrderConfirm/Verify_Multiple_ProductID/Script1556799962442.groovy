...
WebUI.selectOptionByLabel(findTestObject('02_MOBILE/0204_Trade/020402_OrderConfirm/ddJasaPengirimanWarungKami'), 'Kurir Standar', 
    false)

WebUI.delay(2)

WebUI.selectOptionByLabel(findTestObject('02_MOBILE/0204_Trade/020402_OrderConfirm/ddJasaPengirimanWarungKita'), 'Kurir Standar', 
    false)
...
WebUI.selectOptionByLabel(findTestObject('02_MOBILE/0204_Trade/020402_OrderConfirm/ddBankPromotionBNI'), 'MultipleProductID', 
    false)
