...
GlobalVariable.contentText = 'LW'

WebUI.setText(findTestObject('02_MOBILE/0204_Trade/020402_OrderConfirm/txtboxInputKodeVoucher'), GlobalVariable.contentText)
...
if(WebUI.verifyElementPresent(findTestObject('02_MOBILE/0204_Trade/020402_OrderConfirm/lblAlertCoupon'), 2, FailureHandling.OPTIONAL)){
	
	println('Coupon Sudah Di Gunakan') 
} 
else {
	println('Coupon Belum Di Gunakan')
}
