...
WebUI.click(findTestObject('02_MOBILE/0204_Trade/020403_MethodPayment/btnBRI'), FailureHandling.STOP_ON_FAILURE)

WebUI.delay(3)

'menggunakan xpath'
try {
    WebUI.click(findTestObject('02_MOBILE/0204_Trade/020403_MethodPayment/lblKartuKreditBRI'))
}
catch (Exception e) {
    WebUI.click(findTestObject('02_MOBILE/0204_Trade/020403_MethodPayment/lblKartuKreditBRI_Promo'))
} 
