...
WebUI.click(findTestObject('02_MOBILE/0204_Trade/020402_OrderConfirm/BankBNI/BNISmsPayment/dropDownBankBNI'))

WebUI.click(findTestObject('02_MOBILE/0204_Trade/020402_OrderConfirm/BankBNI/BNISmsPayment/rbSMSPayment'))

WebUI.delay(5)

WebUI.verifyElementPresent(findTestObject('02_MOBILE/0204_Trade/020402_OrderConfirm/BankBNI/BNISmsPayment/label62'), 0)

WebUI.setText(findTestObject('02_MOBILE/0204_Trade/020402_OrderConfirm/BankBNI/BNISmsPayment/textBoxNomorHandphone'), GlobalVariable.noHPForSMSPayment)
