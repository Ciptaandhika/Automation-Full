...
WebUI.click(findTestObject('02_MOBILE/0204_Trade/020402_OrderConfirm/Kredivo/rbKredivo'))

WebUI.delay(3)

WebUI.verifyElementPresent(findTestObject('02_MOBILE/0204_Trade/020402_OrderConfirm/Kredivo/labelEstimasiCicilan'), 0)
