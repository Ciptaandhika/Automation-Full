...
WebUI.scrollToElement(findTestObject('02_MOBILE/0204_Trade/020402_OrderConfirm/BankBNI/BNIKartuKreditCicilan/dropDownBankBNI'), 
    0)

WebUI.click(findTestObject('02_MOBILE/0204_Trade/020402_OrderConfirm/BankBNI/BNIKartuKreditCicilan/dropDownBankBNI'))

WebUI.delay(5)

WebUI.click(findTestObject('02_MOBILE/0204_Trade/020402_OrderConfirm/BankBNI/BNIDebitOnline/rbBNIDebitOnline'))
...
koin = WebUI.getText(findTestObject('02_MOBILE/0204_Trade/020402_OrderConfirm/lblKoinBlanjaYangDidapatkan'), FailureHandling.STOP_ON_FAILURE)

koin.equalsIgnoreCase('0')
