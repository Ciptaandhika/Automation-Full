...
WebUI.click(findTestObject('02_MOBILE/0201_Mainsite/020102_Microsite/02010201_Pulsa/Pulsa/ddNominal30kM'))
...
WebUI.click(findTestObject('02_MOBILE/0201_Mainsite/020102_Microsite/02010201_Pulsa/Pulsa/divBankBCAM'))

WebUI.delay(5)

WebUI.click(findTestObject('02_MOBILE/0201_Mainsite/020102_Microsite/02010201_Pulsa/Pulsa/divBCAVAM2'))

WebUI.click(findTestObject('02_MOBILE/0201_Mainsite/020102_Microsite/02010201_Pulsa/Pulsa/btnBayarM'))

WebUI.delay(10)

WebUI.navigateToUrl(GlobalVariable.urlBlanjaanSayaMWeb)
