...
WebUI.selectOptionByIndex(findTestObject('02_MOBILE/0202_Member/020208_Alamat/Instant Courier - Buyer -MWeb/ddKota'), 2)
...
WebUI.click(findTestObject('02_MOBILE/0202_Member/020208_Alamat/Instant Courier - Buyer -MWeb/aCariAlamat'))

WebUI.setText(findTestObject('02_MOBILE/0202_Member/020208_Alamat/Instant Courier - Buyer -MWeb/txtSearchLokasi'), GlobalVariable.namaKadoWisata)

WebUI.click(findTestObject('02_MOBILE/0202_Member/020208_Alamat/Instant Courier - Buyer -MWeb/btnSearchAlamat'))

WebUI.click(findTestObject('02_MOBILE/0202_Member/020208_Alamat/Instant Courier - Buyer -MWeb/btnGunakanLokasi'))

WebUI.verifyElementPresent(findTestObject('02_MOBILE/0202_Member/020208_Alamat/Instant Courier - Buyer -MWeb/lableWarningTidakSesuai'), 
    0)
