...
WebUI.click(findTestObject('02_MOBILE/0202_Member/020203_KoinBlanja/Page_Koin Blanja - BLANJA.com/Page_Koin Blanja - BLANJA.com/buttonGunakanSekarangHL'))

url = WebUI.getUrl()

WebUI.verifyEqual(url, 'https://m.bljstaging.com/')
