...
if ((GlobalVariable.txtBoxShippingDiscount > newShippingFee) && (newTotalAmount > GlobalVariable.txtKoinBlanja_ThresholdSpend)) {
    ...
    ShippingFee2 = WebUI.getText(findTestObject('01_DESKTOP/0104_Trade/010402_OrderConfirm/lblShippingFeePromotion'), FailureHandling.STOP_ON_FAILURE)

    println(ShippingFee)

    println(ShippingFee2)
} else {
