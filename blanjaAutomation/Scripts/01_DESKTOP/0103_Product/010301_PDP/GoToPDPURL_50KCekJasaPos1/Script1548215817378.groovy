...
GlobalVariable.biayaPengirimanPDP = WebUI.getText(findTestObject('01_DESKTOP/0103_Product/010301_PDP/lblBiayaPengiriman'))

GlobalVariable.biayaPengirimanPDP = GlobalVariable.biayaPengirimanPDP.replaceAll('[^\\d]', '')

WebUI.verifyNotEqual(GlobalVariable.biayaPengirimanPDP, '0', FailureHandling.STOP_ON_FAILURE)
