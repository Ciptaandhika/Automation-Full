...
WebUI.navigateToUrl(GlobalVariable.URLSportTraveldanFoodPDP)

if (WebUI.verifyElementPresent(findTestObject('01_DESKTOP/0103_Product/btnCloseEbay'), 2, FailureHandling.OPTIONAL)) {
    WebUI.click(findTestObject('01_DESKTOP/0103_Product/btnCloseEbay'))
} else {
}
