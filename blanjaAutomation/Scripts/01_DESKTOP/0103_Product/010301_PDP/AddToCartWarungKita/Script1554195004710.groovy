...
WebUI.navigateToUrl(GlobalVariable.urlKopiMocca150gr)
...
GlobalVariable.getQtyPDP2 = WebUI.getText(findTestObject('01_DESKTOP/0103_Product/010301_PDP/Pulsa/lableQtyPDP'))
