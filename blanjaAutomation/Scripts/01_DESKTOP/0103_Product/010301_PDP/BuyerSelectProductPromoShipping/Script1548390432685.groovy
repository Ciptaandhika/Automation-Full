...
WebUI.verifyElementPresent(findTestObject('01_DESKTOP/0103_Product/010301_PDP/lblFreeShipping'), 
    1)

WebUI.click(findTestObject('01_DESKTOP/0103_Product/010301_PDP/hrefTambahkankeTroli'))

WebUI.verifyElementPresent(findTestObject('01_DESKTOP/0103_Product/010301_PDP/lblBerhasilDitambahkan'), 
    0)
