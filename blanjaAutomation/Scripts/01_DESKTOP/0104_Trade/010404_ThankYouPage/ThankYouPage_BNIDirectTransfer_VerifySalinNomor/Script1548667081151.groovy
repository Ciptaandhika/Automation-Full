...
//to.addProperty('href', ConditionType.EQUALS, 'javascript:void(0);')
//to.addProperty('class', ConditionType.EQUALS, 'link-copy-account link-copy-account--')
WebUI.click(findTestObject('01_DESKTOP/0104_Trade/010404_ThankYouPage/Bank_Mandiri/Direct_Transfer/hrefSalinNomor'))

statusSalinNomor = WebUI.getAttribute(findTestObject('01_DESKTOP/0104_Trade/010404_ThankYouPage/Bank_Mandiri/Direct_Transfer/hrefSalinNomor'), 
    'class')

log.logInfo(statusSalinNomor)
