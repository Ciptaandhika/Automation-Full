...
WebUI.verifyElementPresent(findTestObject('01_DESKTOP/0104_Trade/010404_ThankYouPage/Bank_Mandiri/Direct_Transfer/divNomorRekeningPembayaran'), 
    0)

WebUI.verifyElementPresent(findTestObject('01_DESKTOP/0104_Trade/010404_ThankYouPage/Bank_Mandiri/Direct_Transfer/labelLogoMandiri'), 
    0)

WebUI.verifyElementText(findTestObject('01_DESKTOP/0104_Trade/010404_ThankYouPage/Bank_Mandiri/Direct_Transfer/label1270066611110'), 
    '127 006 6611 110')

WebUI.verifyElementText(findTestObject('01_DESKTOP/0104_Trade/010404_ThankYouPage/Bank_Mandiri/Direct_Transfer/labelAnPTMetraplasaCabang'), 
