...
listNoPesanan = WebUI.getText(findTestObject('01_DESKTOP/0104_Trade/010404_ThankYouPage/Bank_Mandiri/Direct_Transfer/labelNoPesananAnda'))

String[] noPesananSplit = listNoPesanan.split(',')

noPesananCount = noPesananSplit.size()

log.logInfo((noPesananCount > 1).toString())
