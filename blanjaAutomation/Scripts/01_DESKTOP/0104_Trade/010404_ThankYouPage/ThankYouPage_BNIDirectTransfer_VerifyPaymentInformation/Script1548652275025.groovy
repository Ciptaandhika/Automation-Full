...
tglPembayaranSebelum = WebUI.getText(findTestObject('01_DESKTOP/0104_Trade/010404_ThankYouPage/Bank_Mandiri/Direct_Transfer/labelMohonLakukanPembayaranSebelum'))

int iend = tglPembayaranSebelum.indexOf(' WIB.')

dateInPage = tglPembayaranSebelum.substring(33, iend)
