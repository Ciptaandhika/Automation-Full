...
shippingFeeNinjaXpress = WebUI.getText(findTestObject('01_DESKTOP/0104_Trade/010402_OrderConfirm/lblShippingFeeNinjaXpress'))

println(shippingFeeNinjaXpress)

WebUI.verifyElementPresent(findTestObject('01_DESKTOP/0104_Trade/010402_OrderConfirm/lblWarningJangkauanAreaNinjaXpress'), 
    60)
