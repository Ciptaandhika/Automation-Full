...
WebUI.setText(findTestObject('01_DESKTOP/0101_Mainsite/010101_Homepage/ChoosePaymentPage/txtBoxQtyWarungKita'), GlobalVariable.txtBoxQty50)
...
WebUI.setText(findTestObject('01_DESKTOP/0101_Mainsite/010101_Homepage/ChoosePaymentPage/txtBoxQtyWarungKami'), GlobalVariable.txtBoxQty50)

if (WebUI.verifyElementPresent(findTestObject('01_DESKTOP/0101_Mainsite/010101_Homepage/OrderConfirmPage/lblAlertAcceptNumber'), 
    30)) {
    WebUI.click(findTestObject('01_DESKTOP/0101_Mainsite/010101_Homepage/OrderConfirmPage/btnOKAcceptAllert'))
    WebUI.click(findTestObject('01_DESKTOP/0101_Mainsite/010101_Homepage/ChoosePaymentPage/txtBoxQtyWarungKami'))
} else {
}
