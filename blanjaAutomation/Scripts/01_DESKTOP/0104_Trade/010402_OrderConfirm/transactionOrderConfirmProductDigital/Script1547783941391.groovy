...
email = WebUI.getAttribute(findTestObject('Object Repository/01_DESKTOP/0104_Trade/010402_OrderConfirm/txtEmail'), 'value')

WebUI.verifyNotEqual(email, null)

nomor = WebUI.getAttribute(findTestObject('Object Repository/01_DESKTOP/0104_Trade/010402_OrderConfirm/txtPhone'), 'value')

WebUI.verifyNotEqual(nomor, null)
