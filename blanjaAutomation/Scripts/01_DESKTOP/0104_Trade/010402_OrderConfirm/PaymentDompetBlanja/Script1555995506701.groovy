...
GlobalVariable.getNominal = WebUI.getText(findTestObject('01_DESKTOP/0104_Trade/010403_MethodPayment/Cashback/labelTotalProduk'))

GlobalVariable.getNominal = GlobalVariable.getNominal.replaceAll('\\D+', '')
...
WebUI.setText(findTestObject('01_DESKTOP/0101_Mainsite/010101_Homepage/ChoosePaymentPage/txtBoxDompetBlanjaSaldo'), GlobalVariable.getNominal)

WebUI.delay(2)

WebUI.setText(findTestObject('01_DESKTOP/0101_Mainsite/010101_Homepage/ChoosePaymentPage/lblDompetBlanjaPassword'), GlobalVariable.passwordMPADMIN)
