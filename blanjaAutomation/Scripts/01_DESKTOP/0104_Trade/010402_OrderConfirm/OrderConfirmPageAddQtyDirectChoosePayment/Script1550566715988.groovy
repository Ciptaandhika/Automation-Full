...
WebUI.selectOptionByValue(findTestObject('01_DESKTOP/0101_Mainsite/010101_Homepage/OrderConfirmPage/ddJasaPengiriman'), 
    GlobalVariable.kurir, GlobalVariable.choices)

WebUI.setText(findTestObject('01_DESKTOP/0101_Mainsite/010101_Homepage/OrderConfirmPage/txtBoxQtyBarang'), GlobalVariable.qtyPDPforPayment2)
