...
WebUI.scrollToElement(findTestObject('01_DESKTOP/0104_Trade/010402_OrderConfirm/Scheduler/tabBCA'), 0)

not_run: WebUI.click(findTestObject('01_DESKTOP/0104_Trade/010403_MethodPayment/rbBNIVA'))

WebUI.click(findTestObject('01_DESKTOP/0104_Trade/010402_OrderConfirm/Scheduler/rbKlikBCA'))

WebUI.setText(findTestObject('01_DESKTOP/0104_Trade/010402_OrderConfirm/Scheduler/txtIDKlikBCA'), GlobalVariable.usernameKlikBCA)
