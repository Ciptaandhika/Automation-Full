...
WebUI.click(findTestObject('01_DESKTOP/0104_Trade/010402_OrderConfirm/EditAddress/hrefUbahAlamat'))

WebUI.delay(2)

WebUI.scrollToElement(findTestObject('01_DESKTOP/0104_Trade/010402_OrderConfirm/EditAddress/hrefUbahLokasi'), 2)

WebUI.click(findTestObject('01_DESKTOP/0104_Trade/010402_OrderConfirm/EditAddress/hrefUbahLokasi'))

WebUI.delay(2)

WebUI.scrollToElement(findTestObject('01_DESKTOP/0104_Trade/010402_OrderConfirm/txtAreaCariAlamat2'), 5)
