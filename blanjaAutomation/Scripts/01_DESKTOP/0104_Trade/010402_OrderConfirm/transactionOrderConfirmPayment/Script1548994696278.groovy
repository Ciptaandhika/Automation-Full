...
WebUI.selectOptionByLabel(findTestObject('01_DESKTOP/0103_Product/010301_PDP/Click_select_kurir'), findTestData('Payment/01_DESKTOP/0104_Trade/010402_OrderConfirm/orderConfirmData').getValue(
        'kurirStandarOrderConfirm', 1), GlobalVariable.isTrue)
