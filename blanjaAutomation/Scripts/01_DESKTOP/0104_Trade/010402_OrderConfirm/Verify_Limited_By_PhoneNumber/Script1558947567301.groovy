...
if (WebUI.verifyElementPresent(findTestObject('01_DESKTOP/0104_Trade/010402_OrderConfirm/lblWarningPhoneNumber'), 2, FailureHandling.OPTIONAL)) {
    println('Limited By Phone Number')
} else {
    println(' Not Limited By Phone Number')
}
