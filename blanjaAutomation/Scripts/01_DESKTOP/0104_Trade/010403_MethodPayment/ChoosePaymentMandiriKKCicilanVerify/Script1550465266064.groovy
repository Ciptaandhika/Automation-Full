...
not_run: if (WebUI.verifyElementPresent(findTestObject('01_DESKTOP/0101_Mainsite/010101_Homepage/ChoosePaymentPage/lblAlertPenyalahgunaanAkun'), 
    0)) {
    WebUI.click(findTestObject('01_DESKTOP/0101_Mainsite/010101_Homepage/ChoosePaymentPage/btnOKAlertPenyalahgunaanAkun'))
} else {
}
