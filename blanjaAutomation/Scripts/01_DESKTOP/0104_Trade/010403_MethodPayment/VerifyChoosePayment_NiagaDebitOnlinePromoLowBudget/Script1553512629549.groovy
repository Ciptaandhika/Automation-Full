...
WebUI.verifyOptionSelectedByIndex(findTestObject('01_DESKTOP/0104_Trade/010403_MethodPayment/OthersKartuKredit/ddPilihNamaPromosiFromCreditCard'), 
    GlobalVariable.index1, 0, FailureHandling.STOP_ON_FAILURE)
