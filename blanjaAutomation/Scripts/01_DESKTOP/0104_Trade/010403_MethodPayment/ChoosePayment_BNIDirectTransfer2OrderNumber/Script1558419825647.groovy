...
WebUI.click(findTestObject('01_DESKTOP/0104_Trade/010403_MethodPayment/Bank_BNI/BNI_Direct_Transfer/rbTransferBank'))

WebUI.verifyElementText(findTestObject('01_DESKTOP/0104_Trade/010403_MethodPayment/Bank_BNI/BNI_Direct_Transfer/rbTransferBank'), 
    'Transfer Bank')
