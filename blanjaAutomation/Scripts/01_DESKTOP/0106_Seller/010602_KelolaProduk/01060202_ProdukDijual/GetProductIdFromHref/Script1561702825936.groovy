...
GlobalVariable.urlEvent = WebUI.getAttribute(findTestObject('01_DESKTOP/0106_Seller/010602_KelolaProduk/01060202_ProdukDijual/hrefNamaProdukBaris1'), 
    'href')

String url = GlobalVariable.urlEvent

GlobalVariable.txtBoxProductId5 = url.substring(url.length() - 8)

println(GlobalVariable.txtBoxProductId5)