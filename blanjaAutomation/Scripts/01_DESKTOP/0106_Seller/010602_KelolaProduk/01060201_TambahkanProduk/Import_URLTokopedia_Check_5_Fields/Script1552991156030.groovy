...
log.logInfo('Nama Barang yang diimport :' + importTitle)

log.logInfo('Berat yang diimport :' + importWeight)

log.logInfo('Harga yang diimport :' + importPrice)

log.logInfo('Title yang diimport :' + importDescription)
