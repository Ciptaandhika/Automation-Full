...
WebUI.setText(findTestObject('01_DESKTOP/0106_Seller/010602_KelolaProduk/01060201_TambahkanProduk/NewVersion/txtboxNamaProductNewVersion'), 
    GlobalVariable.namaKeripikSatu)
...
String Filepath = Projectpath + GlobalVariable.imageKeripikNew
...
CustomKeywords.'com.blanja.web.Click_UsingJS.clickUsingJS'(findTestObject('01_DESKTOP/0106_Seller/010602_KelolaProduk/01060201_TambahkanProduk/NewVersion/liSuggestCamilanRinganNewVersion'), 
    30)
...
WebUI.click(findTestObject('01_DESKTOP/0106_Seller/010602_KelolaProduk/01060201_TambahkanProduk/NewVersion/lblTambahDimensiProSeller'))

WebUI.setText(findTestObject('01_DESKTOP/0106_Seller/010602_KelolaProduk/01060201_TambahkanProduk/NewVersion/txtboxPanjangProdNew'), 
    GlobalVariable.txtBlanjaCoupon_ChooseValue20Persen)

WebUI.setText(findTestObject('01_DESKTOP/0106_Seller/010602_KelolaProduk/01060201_TambahkanProduk/NewVersion/txtboxLebarProdNew'), 
    GlobalVariable.editValue30)

WebUI.setText(findTestObject('01_DESKTOP/0106_Seller/010602_KelolaProduk/01060201_TambahkanProduk/NewVersion/txtboxTinggiProdNew'), 
    GlobalVariable.editValue30)
