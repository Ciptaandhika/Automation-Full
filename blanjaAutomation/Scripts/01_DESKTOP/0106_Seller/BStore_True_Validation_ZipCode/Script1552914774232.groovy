...
if (WebUI.verifyElementPresent(findTestObject('01_DESKTOP/0106_Seller/btnOpenStore'), 5, FailureHandling.OPTIONAL)) {
    ...
    String postalcode = WebUI.getAttribute(findTestObject('01_DESKTOP/0106_Seller/txtboxBStorePostalCode'), 'value')
    ...
    WebUI.clearText(findTestObject('01_DESKTOP/0106_Seller/txtboxBStorePostalCode'), FailureHandling.STOP_ON_FAILURE)

    WebUI.delay(3)

    WebUI.setText(findTestObject('01_DESKTOP/0106_Seller/txtboxBStorePostalCode'), GlobalVariable.storeOwnerName)

    WebUI.verifyTextNotPresent(GlobalVariable.storeOwnerName, false)

    WebUI.setText(findTestObject('01_DESKTOP/0106_Seller/txtboxBStorePostalCode'), GlobalVariable.inputCombinationCharacter)
