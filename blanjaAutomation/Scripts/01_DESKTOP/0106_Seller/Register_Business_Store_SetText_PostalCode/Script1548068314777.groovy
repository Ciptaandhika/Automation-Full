...
if (WebUI.verifyElementPresent(findTestObject('01_DESKTOP/0106_Seller/btnOpenStore'), 5, FailureHandling.OPTIONAL)) {
	...
	WebUI.verifyMatch(postalcode, GlobalVariable.postalCode, false)
    ...
    WebUI.selectOptionByIndex(findTestObject('01_DESKTOP/0106_Seller/ddBStoreProvince'), GlobalVariable.ddIndexValue2)
