...
if (WebUI.verifyElementPresent(findTestObject('01_DESKTOP/0106_Seller/btnOpenStore'), 5, FailureHandling.OPTIONAL)) {
    ...
    WebUI.scrollToElement(findTestObject('01_DESKTOP/0106_Seller/txtareaBStoreAlamatToko'), GlobalVariable.setTimeOutGlobal)
    ...
    WebUI.verifyElementPresent(findTestObject('01_DESKTOP/0106_Seller/labelWarningPilihProvinsi'), GlobalVariable.setTimeOutGlobal)
