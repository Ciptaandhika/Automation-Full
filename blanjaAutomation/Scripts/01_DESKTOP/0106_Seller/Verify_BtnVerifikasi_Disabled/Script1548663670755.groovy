...
if (WebUI.verifyElementPresent(findTestObject('01_DESKTOP/0106_Seller/btnOpenStore'), 3, FailureHandling.OPTIONAL)) {
    ...
    WebUI.setText(findTestObject('01_DESKTOP/0106_Seller/txtboxPhoneNumber'), GlobalVariable.inputRegisterNumber)
    ...
    WebUI.uploadFile(findTestObject('01_DESKTOP/0106_Seller/btnUploadLogoToko'), Filepath, FailureHandling.CONTINUE_ON_FAILURE)
    ...
    WebUI.verifyElementNotClickable(findTestObject('01_DESKTOP/0106_Seller/btnVerifyPhoneNumber'), FailureHandling.STOP_ON_FAILURE)
