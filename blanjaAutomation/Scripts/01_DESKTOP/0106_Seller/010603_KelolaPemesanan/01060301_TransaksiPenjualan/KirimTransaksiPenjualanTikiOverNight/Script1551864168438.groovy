...
String mynumber = GlobalVariable.nomorResiTikiOvNightRandom
...
String TikiOvNight_new = (submynumber + formattedDate) + datehour

String TikiOvNightrandom = TikiOvNight_new.replaceAll('\\s+', '')
