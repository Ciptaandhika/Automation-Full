...
WebUI.selectOptionByValue(findTestObject('01_DESKTOP/0106_Seller/010603_KelolaPemesanan/01060301_TransaksiPenjualan/ddPilihJasaPengirimanSellerShipping'), 
    GlobalVariable.jasaPengirimanJnT, GlobalVariable.choices)

String mynumber = GlobalVariable.nomorResiJnT
...
String jnt_newcharacter = (submynumber + formattedDate) + datehour

String jntnewresi = jnt_newcharacter.replaceAll('\\s+', '')
