...
WebUI.verifyElementPresent(findTestObject('01_DESKTOP/0106_Seller/010603_KelolaPemesanan/01060301_TransaksiPenjualan/labelCreditCardInstallment'), 
    0)

String paymentMethod = WebUI.getText(findTestObject('01_DESKTOP/0106_Seller/010603_KelolaPemesanan/01060301_TransaksiPenjualan/labelCreditCardInstallment'))

if (paymentMethod.equalsIgnoreCase('Installment Credit Card')) {
	WebUI.verifyElementText(findTestObject('01_DESKTOP/0106_Seller/010603_KelolaPemesanan/01060301_TransaksiPenjualan/labelCreditCardInstallment'),
		'Installment Credit Card')
}else if (paymentMethod.equalsIgnoreCase('Credit Card Installment')) {
    WebUI.verifyElementText(findTestObject('01_DESKTOP/0106_Seller/010603_KelolaPemesanan/01060301_TransaksiPenjualan/labelCreditCardInstallment'), 
