...
WebUI.verifyElementPresent(findTestObject('01_DESKTOP/0106_Seller/010603_KelolaPemesanan/01060301_TransaksiPenjualan/lblSubShippingPosExpNextDay'), 
    0)

String mynumber = GlobalVariable.nomorResiPosNextDayRandom
...
String posnextday_new = (submynumber + formattedDate) + datehour

String posnextdayrandom = posnextday_new.replaceAll('\\s+', '')
