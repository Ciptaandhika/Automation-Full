...
String mynumber = GlobalVariable.nomorResiTikiRegulerRandom
...
String tikireguler_new = (submynumber + formattedDate) + datehour

String tikiregulerrandom = tikireguler_new.replaceAll('\\s+', '')
