...
if (WebUI.verifyElementPresent(findTestObject('01_DESKTOP/0106_Seller/btnOpenStore'), 5, FailureHandling.OPTIONAL)) {
    ...
    WebUI.verifyElementClickable(findTestObject('01_DESKTOP/0106_Seller/btnBackToTypeStore'))

    WebUI.click(findTestObject('01_DESKTOP/0106_Seller/btnBackToTypeStore'), FailureHandling.STOP_ON_FAILURE)

    SuccesURL = WebUI.getUrl()

    SuccesURL.contains('registration/shop/type')
} else {
    WebUI.verifyElementClickable(findTestObject('01_DESKTOP/0106_Seller/btnBackToTypeStore'))
