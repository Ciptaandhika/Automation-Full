...
WebUI.click(findTestObject('01_DESKTOP/0106_Seller/btnKirimUlangVerifyPhoneNumber'), FailureHandling.STOP_ON_FAILURE)

WebUI.delay(3)

WebUI.verifyElementNotVisible(findTestObject('01_DESKTOP/0106_Seller/btnKirimUlangVerifyPhoneNumber'), FailureHandling.STOP_ON_FAILURE)
