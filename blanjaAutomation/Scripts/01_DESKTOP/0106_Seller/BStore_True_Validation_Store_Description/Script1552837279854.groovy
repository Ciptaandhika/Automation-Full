...
if (WebUI.verifyElementPresent(findTestObject('01_DESKTOP/0106_Seller/btnOpenStore'), 5, FailureHandling.OPTIONAL)) {
    ...
    WebUI.setText(findTestObject('01_DESKTOP/0106_Seller/txtareaDeskripsiToko'), GlobalVariable.input500karakter)

    String karakter = GlobalVariable.input500karakter

    mychar = karakter.length()

    String deskripsitoko = WebUI.getAttribute(findTestObject('01_DESKTOP/0106_Seller/txtareaDeskripsiToko'), 'value')
    ...
    WebUI.clearText(findTestObject('01_DESKTOP/0106_Seller/txtareaDeskripsiToko'), FailureHandling.STOP_ON_FAILURE)

    WebUI.setText(findTestObject('01_DESKTOP/0106_Seller/txtareaDeskripsiToko'), GlobalVariable.URLProdukRegular5KMainsite)
