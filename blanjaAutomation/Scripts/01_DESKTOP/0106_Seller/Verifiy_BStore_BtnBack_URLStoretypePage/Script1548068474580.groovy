...
if (WebUI.verifyElementPresent(findTestObject('01_DESKTOP/0106_Seller/btnOpenStore'), 5, FailureHandling.OPTIONAL)) {
    ...
    WebUI.verifyElementClickable(findTestObject('01_DESKTOP/0106_Seller/btnBStoreKembali'), FailureHandling.STOP_ON_FAILURE)

    WebUI.click(findTestObject('01_DESKTOP/0106_Seller/btnBStoreKembali'))
