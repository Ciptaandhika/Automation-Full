...
if (WebUI.verifyElementPresent(findTestObject('01_DESKTOP/0106_Seller/btnOpenStore'), 5, FailureHandling.OPTIONAL)) {
    ...
    WebUI.setText(findTestObject('01_DESKTOP/0106_Seller/txtboxBStoreNamaToko'), GlobalVariable.input35Karakter)

    String karakter = GlobalVariable.input35Karakter

    mychar = karakter.length()

    String shopname = WebUI.getAttribute(findTestObject('01_DESKTOP/0106_Seller/txtboxBStoreNamaToko'), 'value')
    ...
    WebUI.setText(findTestObject('01_DESKTOP/0106_Seller/txtboxBStoreNamaToko'), GlobalVariable.inputSameStoreCaseSensitive)
