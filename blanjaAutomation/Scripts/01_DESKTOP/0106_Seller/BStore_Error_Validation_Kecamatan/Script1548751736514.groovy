...
if (WebUI.verifyElementPresent(findTestObject('01_DESKTOP/0106_Seller/btnOpenStore'), 5, FailureHandling.OPTIONAL)) {
    ...
    WebUI.scrollToElement(findTestObject('01_DESKTOP/0106_Seller/txtareaAlamatToko'), 0)
    ...
    WebUI.selectOptionByIndex(findTestObject('01_DESKTOP/0106_Seller/ddBStoreRegency'), GlobalVariable.ddIndexValue2)

    WebUI.verifyElementPresent(findTestObject('01_DESKTOP/0106_Seller/labelWarningPilihKecamatan'), GlobalVariable.setTimeOutGlobal)
