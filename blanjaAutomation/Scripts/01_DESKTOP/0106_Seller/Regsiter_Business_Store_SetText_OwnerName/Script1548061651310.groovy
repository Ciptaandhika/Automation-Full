...
if (WebUI.verifyElementPresent(findTestObject('01_DESKTOP/0106_Seller/btnOpenStore'), 5, FailureHandling.OPTIONAL)) {
    ...
    String ownername = WebUI.getAttribute(findTestObject('01_DESKTOP/0106_Seller/txtboxBStoreOwnerName'), 'value')

    log.logInfo(ownername)

    WebUI.verifyMatch(ownername, GlobalVariable.storeOwnerName, false)
