...
if (WebUI.verifyElementPresent(findTestObject('01_DESKTOP/0106_Seller/btnOpenStore'), 5, FailureHandling.OPTIONAL)) {
    ...
    WebUI.scrollToElement(findTestObject('01_DESKTOP/0106_Seller/txtboxShopDomain'), GlobalVariable.setTimeOutGlobal)
    ...
    WebUI.uploadFile(findTestObject('01_DESKTOP/0106_Seller/btnUploadLogoToko'), pngImage)
    ...
    WebUI.uploadFile(findTestObject('01_DESKTOP/0106_Seller/btnUploadLogoToko'), largeImage)
