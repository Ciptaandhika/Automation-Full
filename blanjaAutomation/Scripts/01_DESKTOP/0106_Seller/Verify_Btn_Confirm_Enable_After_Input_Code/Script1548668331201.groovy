...
if (WebUI.verifyElementPresent(findTestObject('01_DESKTOP/0106_Seller/btnOpenStore'), 3, FailureHandling.OPTIONAL)) {
    ...
    WebUI.mouseOver(findTestObject('01_DESKTOP/0106_Seller/txtboxInputCode3'))

    WebUI.click(findTestObject('01_DESKTOP/0106_Seller/txtboxInputCode3'))

    WebUI.setText(findTestObject('01_DESKTOP/0106_Seller/txtboxInputCode1'), GlobalVariable.setTimeOutGlobal)

    WebUI.setText(findTestObject('01_DESKTOP/0106_Seller/txtboxInputCode2'), GlobalVariable.setTimeOutGlobal)

    WebUI.setText(findTestObject('01_DESKTOP/0106_Seller/txtboxInputCode3'), GlobalVariable.setTimeOutGlobal)

    WebUI.setText(findTestObject('01_DESKTOP/0106_Seller/txtboxInputCode4'), GlobalVariable.setTimeOutGlobal)

    WebUI.setText(findTestObject('01_DESKTOP/0106_Seller/txtboxInputCode5'), GlobalVariable.setTimeOutGlobal)

    WebUI.setText(findTestObject('01_DESKTOP/0106_Seller/txtboxInputCode6'), GlobalVariable.setTimeOutGlobal)

    WebUI.verifyElementClickable(findTestObject('01_DESKTOP/0106_Seller/btnVerifyPhoneNumber'))
}
