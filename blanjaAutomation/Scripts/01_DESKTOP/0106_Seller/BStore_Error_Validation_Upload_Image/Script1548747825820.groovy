...
if (WebUI.verifyElementPresent(findTestObject('01_DESKTOP/0106_Seller/btnOpenStore'), 5, FailureHandling.OPTIONAL)) {
    ...
    WebUI.uploadFile(findTestObject('01_DESKTOP/0106_Seller/btnBStoreUploadLogoToko'), pngImage)
    ...
    WebUI.uploadFile(findTestObject('01_DESKTOP/0106_Seller/btnBStoreUploadLogoToko'), largeImage)
