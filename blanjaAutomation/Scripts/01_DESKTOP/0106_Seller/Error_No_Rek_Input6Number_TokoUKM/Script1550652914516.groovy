...
WebUI.setText(findTestObject('01_DESKTOP/0106_Seller/txtboxNomorRekeningTokoUKM'), GlobalVariable.input6DigitNumber)

WebUI.sendKeys(findTestObject('01_DESKTOP/0106_Seller/txtboxNamaPemilikRekeningRegisterUKM'), Keys.chord(Keys.TAB))

WebUI.verifyElementPresent(findTestObject('01_DESKTOP/0106_Seller/lblWarningNoRek6KarakterTokoUKM'), 0)
