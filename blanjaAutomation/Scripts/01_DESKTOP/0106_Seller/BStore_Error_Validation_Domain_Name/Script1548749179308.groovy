...
if (WebUI.verifyElementPresent(findTestObject('01_DESKTOP/0106_Seller/btnOpenStore'), 5, FailureHandling.OPTIONAL)) {
    ...
    WebUI.sendKeys(findTestObject('01_DESKTOP/0106_Seller/txtboxBStoreDomainToko'), Keys.chord(Keys.BACK_SPACE))
    ...
    WebUI.setText(findTestObject('01_DESKTOP/0106_Seller/txtboxBStoreDomainToko'), GlobalVariable.input1Character)
    ...
    WebUI.clearText(findTestObject('01_DESKTOP/0106_Seller/txtboxBStoreDomainToko'))

    WebUI.setText(findTestObject('01_DESKTOP/0106_Seller/txtboxBStoreDomainToko'), GlobalVariable.inputSameStore)
    ...
    WebUI.sendKeys(findTestObject('01_DESKTOP/0106_Seller/txtboxBStoreDomainToko'), Keys.chord(Keys.CONTROL, 'a', Keys.BACK_SPACE))
