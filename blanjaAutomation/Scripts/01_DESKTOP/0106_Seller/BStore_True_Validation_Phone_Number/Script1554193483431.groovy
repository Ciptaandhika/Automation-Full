...
if (WebUI.verifyElementPresent(findTestObject('01_DESKTOP/0106_Seller/btnOpenStore'), 5, FailureHandling.OPTIONAL)) {
    ...
    WebUI.setText(findTestObject('01_DESKTOP/0106_Seller/txtboxPhoneNumber'), GlobalVariable.storeOwnerName)

    WebUI.verifyTextNotPresent(GlobalVariable.storeOwnerName, false)

    WebUI.setText(findTestObject('01_DESKTOP/0106_Seller/txtboxPhoneNumber'), GlobalVariable.inputCombinationCharacter)
