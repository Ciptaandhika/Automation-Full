...
WebUI.scrollToElement(findTestObject('01_DESKTOP/0106_Seller/txtboxBStoreBranchName'), GlobalVariable.setTimeOutGlobal)

String userDir = System.getProperty('user.dir')

String pngImage = userDir + GlobalVariable.pngimage

WebUI.uploadFile(findTestObject('01_DESKTOP/0106_Seller/btnBStoreUploadNPWP'), pngImage)
...
WebUI.uploadFile(findTestObject('01_DESKTOP/0106_Seller/btnBStoreUploadNPWP'), largeImage)
