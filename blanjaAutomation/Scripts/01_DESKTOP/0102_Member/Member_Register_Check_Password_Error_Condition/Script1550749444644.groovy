...
WebUI.click(findTestObject('01_DESKTOP/0102_Member/txtboxPasswordRegisterBlanja'), FailureHandling.STOP_ON_FAILURE)

WebUI.click(findTestObject('01_DESKTOP/0102_Member/txtboxConfirmPasswordRegisterBlanja'), FailureHandling.STOP_ON_FAILURE)
