...
WebUI.setText(findTestObject('01_DESKTOP/0102_Member/010201_LoginPage/txtBoxUsernameBuyer01'), GlobalVariable.usernameSeller02LoginPage)
...
try {
	WebUI.click(findTestObject('Object Repository/01_DESKTOP/0106_Seller/btnX'))
}
