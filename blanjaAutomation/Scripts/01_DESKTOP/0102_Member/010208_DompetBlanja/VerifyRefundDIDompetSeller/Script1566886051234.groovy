...
int buyerrefund = getrefund.toInteger() * 2

String gettotalharga = GlobalVariable.getTotalAmount

int totalharga = gettotalharga.toInteger()

int exppemasukanseller = totalharga - buyerrefund

actualpemasukanseller = Columns_row.get(2).getText().replaceAll("[^0-9]", "")

println(actualpemasukanseller)

WebUI.verifyEqual(actualpemasukanseller, exppemasukanseller)
