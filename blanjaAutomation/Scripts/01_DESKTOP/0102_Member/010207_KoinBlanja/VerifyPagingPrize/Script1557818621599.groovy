...
WebUI.verifyElementPresent(findTestObject('01_DESKTOP/0102_Member/010207_KoinBlanja/lblPaging8'), 3)

WebUI.delay(3)

WebUI.click(findTestObject('01_DESKTOP/0102_Member/010207_KoinBlanja/li_2'))

WebUI.delay(3)

WebUI.verifyElementPresent(findTestObject('01_DESKTOP/0102_Member/010207_KoinBlanja/lblPaging2'), 3)
