...
WebUI.click(findTestObject('01_DESKTOP/0102_Member/010207_KoinBlanja/btnTidakTukarPoin'))

currentCoinBlanja = WebUI.getText(findTestObject('01_DESKTOP/0102_Member/010207_KoinBlanja/lblSaldoCoinBlanja'))

WebUI.verifyElementPresent(findTestObject('01_DESKTOP/0102_Member/010207_KoinBlanja/divHadiahUndian'), 30)

if (WebUI.verifyEqual(earlyCoinBlanja, currentCoinBlanja)) {
