...
WebUI.verifyTextPresent('Pembayaran :BNI VA', false)

promotext = "Promo Seller(" + GlobalVariable.contentText + ")"

actualText = WebUI.getText(findTestObject('Object Repository/01_DESKTOP/0102_Member/010203_BlanjaanSaya/labelPromoOngkirSeller')).replaceAll('\\n', "")

println(actualText)

WebUI.verifyEqual(actualText, promotext)

//if (WebUI.getText(findTestObject('Object Repository/01_DESKTOP/0102_Member/010203_BlanjaanSaya/labelPromoOngkirSeller')).contains(promotext)){
//	
