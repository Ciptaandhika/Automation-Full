...
WebUI.setText(findTestObject('01_DESKTOP/0102_Member/010203_BlanjaanSaya/txtBoxOrderNumberBlanjaanSaya'), GlobalVariable.NomorOrder1)
...
WebUI.callTestCase(findTestCase('01_DESKTOP/0102_Member/010203_BlanjaanSaya/020302_RefundDetail/BuyerRefund'), [:], FailureHandling.STOP_ON_FAILURE)

WebUI.navigateToUrl(GlobalVariable.urlMemberOrderListBlanjaanSaya)

WebUI.click(findTestObject('01_DESKTOP/0102_Member/010203_BlanjaanSaya/btnTCASH'), FailureHandling.OPTIONAL)

WebUI.setText(findTestObject('01_DESKTOP/0102_Member/010203_BlanjaanSaya/txtBoxOrderNumberBlanjaanSaya'), GlobalVariable.NomorOrder2)
