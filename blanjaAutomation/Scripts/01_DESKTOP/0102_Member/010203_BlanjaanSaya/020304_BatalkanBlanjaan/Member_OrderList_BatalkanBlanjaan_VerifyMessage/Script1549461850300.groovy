...
WebUI.verifyElementPresent(findTestObject('01_DESKTOP/0102_Member/010203_BlanjaanSaya/020304_BatalkanBlanjaan/labelDenganMembatalkanPesanan'), 
    0)
...
//for(int i=0; i<GlobalVariable.varTotalProductOrdered; i++){}
