...
WebUI.verifyTextPresent('Pembayaran :KlikBCA', false)

WebUI.scrollToElement(findTestObject('01_DESKTOP/0102_Member/010203_BlanjaanSaya/btnChangePayment'), 0)

not_run: WebUI.click(findTestObject('01_DESKTOP/0102_Member/010203_BlanjaanSaya/hrefRincian_Blanjaan'))

not_run: WebUI.switchToWindowIndex(GlobalVariable.index1)
...
WebUI.verifyElementNotPresent(findTestObject('01_DESKTOP/0104_Trade/010403_MethodPayment/Bank_BCA/btnKlikBCA'), 0)
