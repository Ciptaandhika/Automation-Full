...
WebUI.setText(findTestObject('01_DESKTOP/0102_Member/010203_BlanjaanSaya/txtboxNomorOrder'), GlobalVariable.orderNumberTemp_1)
...
WebUI.verifyTextPresent('Pembayaran :ATM Transfer', false)

WebUI.scrollToElement(findTestObject('01_DESKTOP/0102_Member/010203_BlanjaanSaya/btnCari'), 0)

WebUI.delay(5)

WebUI.click(findTestObject('01_DESKTOP/0102_Member/010203_BlanjaanSaya/hrefBatalkanBlanja'))

WebUI.verifyElementPresent(findTestObject('01_DESKTOP/0102_Member/010203_BlanjaanSaya/020304_BatalkanBlanjaan/txtPembatalanBlanjaanLain'), 
    0)
