...
WebUI.verifyTextPresent('Pembayaran :Debit Online', false, FailureHandling.OPTIONAL)

WebUI.verifyTextPresent('Pembayaran :Kartu Kredit', false, FailureHandling.OPTIONAL)

WebUI.verifyTextPresent('Pembayaran :BCA KlikPay', false, FailureHandling.OPTIONAL)
...
WebUI.verifyElementPresent(findTestObject('01_DESKTOP/0102_Member/010203_BlanjaanSaya/020301_OrderDetail/btnPetunjukPembayaran'), 
    0)

WebUI.verifyElementPresent(findTestObject('01_DESKTOP/0102_Member/010203_BlanjaanSaya/020301_OrderDetail/btnBatalkanBlanjaan'), 
    0)
