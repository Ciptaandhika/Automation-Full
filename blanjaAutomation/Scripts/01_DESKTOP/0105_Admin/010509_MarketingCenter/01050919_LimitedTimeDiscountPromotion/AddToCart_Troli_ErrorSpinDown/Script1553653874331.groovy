...
WebUI.setText(findTestObject('01_DESKTOP/0103_Product/010301_PDP/txtBoxQty'), GlobalVariable.budgetTypeAll)
...
WebUI.click(findTestObject('01_DESKTOP/0105_Admin/010509_MarketingCenter/01050919_LimitedTimeDiscountPromotion/Page_Keranjang Belanja Saya - BLANJ/spinDown'), 
    FailureHandling.STOP_ON_FAILURE)

WebUI.verifyTextPresent(GlobalVariable.budgetTypeAll, true)
