...
site_id = (((GlobalVariable.txtBoxPromotionName4 + ' ') + formattedDate) + datehour)
...
WebUI.setText(findTestObject('01_DESKTOP/0105_Admin/010509_MarketingCenter/01050919_LimitedTimeDiscountPromotion/Limited Time Discount Promotion/txtBoxEachBuyer'), 
    GlobalVariable.ltd900)

WebUI.setText(findTestObject('01_DESKTOP/0105_Admin/010509_MarketingCenter/01050919_LimitedTimeDiscountPromotion/Page_/txtBoxPromInvFit'), 
    GlobalVariable.ltd900)

WebUI.setText(findTestObject('01_DESKTOP/0105_Admin/010509_MarketingCenter/01050919_LimitedTimeDiscountPromotion/Limited Time Discount Promotion/Page_/txtBoxSellerNetBasoFit'), 
    GlobalVariable.ltd85000)
