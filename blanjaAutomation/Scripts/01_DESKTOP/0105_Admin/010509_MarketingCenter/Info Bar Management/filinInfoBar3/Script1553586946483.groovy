...
WebUI.setText(findTestObject('01_DESKTOP/0105_Admin/010509_MarketingCenter/Info Bar Management/txtBoxText'), 'cek tokonya disni ')

WebUI.click(findTestObject('01_DESKTOP/0105_Admin/010509_MarketingCenter/Info Bar Management/rbtnRedirectURLDesktop'))

WebUI.setText(findTestObject('01_DESKTOP/0105_Admin/010509_MarketingCenter/Info Bar Management/txtboxRedirectURLDesktop'), 
    'www. blanja.com/unilever')
