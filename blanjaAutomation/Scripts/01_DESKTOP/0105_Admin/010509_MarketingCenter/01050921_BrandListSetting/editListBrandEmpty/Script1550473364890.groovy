...
WebUI.uploadFile(findTestObject('01_DESKTOP/0105_Admin/010509_MarketingCenter/01050921_BrandListSetting/uploadFileImage'), 
    GlobalVariable.empty)

WebUI.setText(findTestObject('01_DESKTOP/0105_Admin/010509_MarketingCenter/01050921_BrandListSetting/txtBoxBrandTitle'), 
    GlobalVariable.empty)
...
WebUI.verifyTextPresent(GlobalVariable.errorTitleListBrand, true)
