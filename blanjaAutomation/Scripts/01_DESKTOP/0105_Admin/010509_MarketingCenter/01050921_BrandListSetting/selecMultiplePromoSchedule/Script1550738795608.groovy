...
//new_btn = WebUI.modifyObjectProperty(findTestObject('01_DESKTOP/0105_Admin/010509_MarketingCenter/01050921_BrandListSetting/cbxPromo'),
//'promoname', 'equals', promoName, false)
//println(WebUI.getAttribute(new_btn, 'promoname'))
//WebUI.check(newObject)

//WebUI.click(findTestObject('01_DESKTOP/0105_Admin/010509_MarketingCenter/01050921_BrandListSetting/btnDeleteSchedule'))

//WebUI.click(findTestObject('01_DESKTOP/0105_Admin/010509_MarketingCenter/01050921_BrandListSetting/Page_/btnConfmDeleteSchedule'))
