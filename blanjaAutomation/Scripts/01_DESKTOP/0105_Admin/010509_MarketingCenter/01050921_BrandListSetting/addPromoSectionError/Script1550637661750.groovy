...
WebUI.setText(findTestObject('01_DESKTOP/0105_Admin/010509_MarketingCenter/01050921_BrandListSetting/Page_Upload Promo Section - BLANJA/textBoxProductList'), 
    GlobalVariable.productListError)
...
not_run: String Filepath4 = Projectpath + GlobalVariable.filePromo560

not_run: WebUI.uploadFile(findTestObject('01_DESKTOP/0105_Admin/010509_MarketingCenter/01050921_BrandListSetting/Page_Upload Promo Section - BLANJA/uploadInnerMobile'), 
    Filepath4)

WebUI.click(findTestObject('01_DESKTOP/0105_Admin/010509_MarketingCenter/01050921_BrandListSetting/Page_Upload Promo Section - BLANJA/btnAddPromo'))

WebUI.verifyTextPresent(GlobalVariable.errorInformation, true)
