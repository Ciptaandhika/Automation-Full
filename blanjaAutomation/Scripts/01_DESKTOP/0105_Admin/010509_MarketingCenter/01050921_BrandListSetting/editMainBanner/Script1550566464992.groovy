...
WebUI.click(findTestObject('01_DESKTOP/0105_Admin/010509_MarketingCenter/01050921_BrandListSetting/Banner Setting/hrefEdit'))
...
WebUI.click(findTestObject('01_DESKTOP/0105_Admin/010509_MarketingCenter/01050921_BrandListSetting/Banner Setting/btnUpdateMainBanner'))

WebUI.click(findTestObject('01_DESKTOP/0105_Admin/010509_MarketingCenter/01050921_BrandListSetting/Banner Setting/btnOkEdit1'))

WebUI.click(findTestObject('01_DESKTOP/0105_Admin/010509_MarketingCenter/01050921_BrandListSetting/Banner Setting/btnOkEdit2'))

WebUI.verifyTextPresent(GlobalVariable.txtSamsung, true)

WebUI.verifyTextPresent(GlobalVariable.blLinkBanner, true)
