...
startTimeRedeem = WebUI.getAttribute(findTestObject('01_DESKTOP/0105_Admin/010509_MarketingCenter/01050901_KoinBlanja/LotteryForm/txtLotteryStartTimeRedeem'), 
    'value')

endTimeRedeem = WebUI.getAttribute(findTestObject('01_DESKTOP/0105_Admin/010509_MarketingCenter/01050901_KoinBlanja/LotteryForm/txtLotteryEndTimeRedeem'), 
    'value')

println(startTimeRedeem)

println(endTimeRedeem)
