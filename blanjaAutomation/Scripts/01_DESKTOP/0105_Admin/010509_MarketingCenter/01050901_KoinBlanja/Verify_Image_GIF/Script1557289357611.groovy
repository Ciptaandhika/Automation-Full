...
String Filepath = Projectpath + '\\image\\giphy.gif'
...
WebUI.verifyElementPresent(findTestObject('01_DESKTOP/0105_Admin/010509_MarketingCenter/01050901_KoinBlanja/lblAlertImageFileGIF'), 
    60)
