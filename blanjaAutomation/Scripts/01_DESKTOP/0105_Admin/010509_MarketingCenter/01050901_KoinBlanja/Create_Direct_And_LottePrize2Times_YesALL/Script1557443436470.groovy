...
WebUI.setText(findTestObject('01_DESKTOP/0105_Admin/010509_MarketingCenter/01050901_KoinBlanja/txtboxRow2PrizeTitle'), GlobalVariable.txtBlanjaCoupons_CouponName30k)
...
WebUI.comment('Lottery Prize Row 1')
...
WebUI.comment('Lottery Prize Row 2')
