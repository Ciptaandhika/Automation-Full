...
log.logInfo(txt)
txt.contains('campaignId')
txt.contains('&utm_source=Donat%20Payu1')
txt.contains('&utm_medium=Donat%20Payu1')
txt.contains('&utm_campaign=Donat%20Payu1')
txt.contains('&utm_term=Donat%20Payu1')
txt.contains('&utm_content=Donat%20Payu1')
