...
CustomKeywords.'com.mii.AutoDatePicker.pickDateDynamic'(findTestObject('01_DESKTOP/0105_Admin/010504_TakeRateManagement/050401_TakeRateSetting/txtInputStartDateTakerate'), 
    GlobalVariable.startDate, 143)

WebUI.delay(2)

CustomKeywords.'com.mii.AutoDatePicker.pickDateDynamic'(findTestObject('01_DESKTOP/0105_Admin/010504_TakeRateManagement/050401_TakeRateSetting/txtInputEndDateTakerate'), 
    GlobalVariable.startDate, 144)
...
WebUI.verifyElementPresent(findTestObject('01_DESKTOP/0105_Admin/010504_TakeRateManagement/050401_TakeRateSetting/lblPopupDuplicateTRSetting'), 
    30)
