...
WebUI.verifyTextPresent('Payment Method :Online', false)

WebUI.verifyElementText(findTestObject('01_DESKTOP/0105_Admin/010502_TransactionManagement/01050203_OrderManagement/labelPaymentCodeBlank'), 
    'Payment Code :')
