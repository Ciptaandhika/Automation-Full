...
GlobalVariable.PaymentCodeOrderManagement = GlobalVariable.PaymentCodeOrderManagement.substring(14, 28).trim()

log.logInfo(GlobalVariable.PaymentCodeOrderManagement)
