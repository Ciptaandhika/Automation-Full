...
product1 = WebUI.getText(findTestObject('01_DESKTOP/0105_Admin/010503_CategoryManagement/01050310_MigrateProductListing/lblListProductNum1MigrateListing'))

product2 = WebUI.getText(findTestObject('01_DESKTOP/0105_Admin/010503_CategoryManagement/01050310_MigrateProductListing/lblListProductNum2MigrateListing'))
...
historyProduct1 = WebUI.getText(findTestObject('01_DESKTOP/0105_Admin/010503_CategoryManagement/01050310_MigrateProductListing/lblMigrateHistoryProduct1'))

historyProduct2 = WebUI.getText(findTestObject('01_DESKTOP/0105_Admin/010503_CategoryManagement/01050310_MigrateProductListing/lblMigrateHistoryProduct2'))

WebUI.verifyMatch(product1, historyProduct2, false)

WebUI.verifyMatch(product2, historyProduct1, false)
