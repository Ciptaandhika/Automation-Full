...
WebUI.click(findTestObject('01_DESKTOP/0105_Admin/010514_DigitalProductManagement/01051401_PrepaidCreditSetting/btnEditDifferent'))
...
if (Integer.parseInt(GlobalVariable.OperatorName.toString()).equals(1)) {
    WebUI.selectOptionByIndex(findTestObject('01_DESKTOP/0105_Admin/010514_DigitalProductManagement/01051401_PrepaidCreditSetting/txtBoxProviderName1'), 
    ...
    WebUI.selectOptionByIndex(findTestObject('01_DESKTOP/0105_Admin/010514_DigitalProductManagement/01051401_PrepaidCreditSetting/txtBoxType2'), 
        GlobalVariable.Type)
...
WebUI.click(findTestObject('01_DESKTOP/0105_Admin/010514_DigitalProductManagement/01051401_PrepaidCreditSetting/cbUnlimitedStockYes'))
...
WebUI.click(findTestObject('01_DESKTOP/0105_Admin/010514_DigitalProductManagement/01051401_PrepaidCreditSetting/btnPopUpOK1'))

WebUI.verifyElementText(findTestObject('01_DESKTOP/0105_Admin/010514_DigitalProductManagement/01051401_PrepaidCreditSetting/LabelSkuIdAlreadyExist'), 
    'Credit Setting with choosen Provider and Nominal is already exist')
