...
WebUI.navigateToUrl(GlobalVariable.RedirectURLGaruda)
...
not_run: WebUI.setText(findTestObject('01_DESKTOP/0101_Mainsite/010102_Microsite/01010204_GarudaIndonesia/txtBoxPromoCode'), 
    GlobalVariable.KodePromo)

not_run: WebUI.click(findTestObject('01_DESKTOP/0101_Mainsite/010102_Microsite/01010204_GarudaIndonesia/btnTanggalPergi'))

not_run: WebUI.click(findTestObject('01_DESKTOP/0101_Mainsite/010102_Microsite/01010204_GarudaIndonesia/hrefa_24'))

WebUI.scrollToElement(findTestObject('01_DESKTOP/0101_Mainsite/010102_Microsite/01010204_GarudaIndonesia/txtBoxDewasa'), 
    0)

not_run: WebUI.selectOptionByValue(findTestObject('01_DESKTOP/0101_Mainsite/010102_Microsite/01010204_GarudaIndonesia/txtBoxDewasa'), 
    GlobalVariable.BangkuDewasa, true)
...
not_run: WebUI.selectOptionByValue(findTestObject('01_DESKTOP/0101_Mainsite/010102_Microsite/01010204_GarudaIndonesia/txtBoxAnak'), 
    GlobalVariable.BangkuAnak, true)
...
not_run: WebUI.selectOptionByValue(findTestObject('01_DESKTOP/0101_Mainsite/010102_Microsite/01010204_GarudaIndonesia/txtBoxBayi'), 
    GlobalVariable.BangkuBayi, true)
