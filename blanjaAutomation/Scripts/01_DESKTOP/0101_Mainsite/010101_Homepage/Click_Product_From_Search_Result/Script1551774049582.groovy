...
WebUI.click(findTestObject('01_DESKTOP/0101_Mainsite/010101_Homepage/HomepageIndah/hrefProductPanteneSearchResult'))

katalogURL = WebUI.getUrl()

katalogURL.contains('bljstaging.com/katalog')
