...
WebUI.setText(findTestObject('01_DESKTOP/0101_Mainsite/010101_Homepage/txtBoxSearchKeyWords'), GlobalVariable.sunsilkKeyWord)
...
WebUI.verifyElementPresent(findTestObject('01_DESKTOP/0101_Mainsite/010101_Homepage/NewAndSecondProduct/lblProductSearchResultSunsilk'), 
    30)

WebUI.selectOptionByIndex(findTestObject('01_DESKTOP/0101_Mainsite/010101_Homepage/NewAndSecondProduct/ddNewSecondConditionProduct'), 
    GlobalVariable.ddIndexValue)

WebUI.verifyElementPresent(findTestObject('01_DESKTOP/0101_Mainsite/010101_Homepage/NewAndSecondProduct/lbl_ItemTidakDiTemukan'), 
    30)
